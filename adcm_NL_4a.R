...
apollo_control = list(
  modelName       = "NL_4a",
  modelDescr      = "Three-level NL model with TRANSFER nest",
  indivID         = "NUMERIC", 
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  nlNests      = list(root=1, 
                      ...
                      transfer=lambda_transfer)
  
  ### Specify tree structure for NL model
  nlStructure= list()
  nlStructure[["root"]]     = c("private","public","transfer")
  nlStructure[["private"]]  = c("auto","companion")
  nlStructure[["public"]]   = c("taxi","metro","bus")
  nlStructure[["transfer"]] = c("autometro","compmetro","taximetro","busmetro")
